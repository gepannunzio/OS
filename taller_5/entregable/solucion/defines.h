...
#define DESC_PRIVILIGE_USER 0x3

/* COMPLETAR - Tamaños de segmentos */ 
#define FLAT_SEGM_SIZE   GDT_LIMIT_4KIB(856686592) //El numero es 817 * 2a la 20)
#define VIDEO_SEGM_SIZE  GDT_LIMIT_BYTES((50 * 80) * 2)// (50 * 80) * 16
