...
void screen_draw_layout(void) {
  ...
  char * text = "Marcos, Andy y German";
  uint8_t attr1 = C_FG_RED | C_BG_CYAN;
  uint8_t attr2 = C_FG_BLUE | C_BG_BROWN;
  print(text, 30, 20, attr1);
  print(text, 30, 21, attr2);
  attr1 = C_FG_GREEN;
  char * orga[6] = {
